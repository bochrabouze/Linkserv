<template>
 ...
 <v-col
  ...
  export default {
    data: () => ({
        search: '',    
      listProfessions: ['Plumbing ',' Carpentry ',' Gardening ',' Hotel ',' Catering ',' Secretariat ',' Transport ',' Delivery ',' Engineering ',' Technicians', 'Electricity', 'Mechanics',' Industry ' ],      
      dialog: false,
      dialogDelete: false,
      headers: [
        {
    ...
    computed: {
      formTitle () {
        return this.editedIndex === -1 ? 'Add servant' : 'Edit servant'
      },
    },
     ...
     getPermis(){
      ...
      save () {
        ...
        console.log(this.editedItem);
         ...
         axios.post('/app/servant',this.editedItem)
                .then(response => {
                   console.log(response.data);
